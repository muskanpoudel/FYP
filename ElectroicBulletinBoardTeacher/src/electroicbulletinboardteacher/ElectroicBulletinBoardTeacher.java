 ...
 */
package electroicbulletinboardteacher;
 ...
 * @author Muskan
 */
public class ElectroicBulletinBoardTeacher extends Application {
    ...
    public void showMainStage(Stage stage) {
        try {
            ...
            stage.setTitle("EBBS. Teacher Interface.");
            //stage.getIcons().add(new Image(getClass().getResourceAsStream("/img/icon.png")));
            StuffHolder.setStageMain(stage);
            stage.show();
        } catch (Exception ex) {
            Logger.getLogger(ElectroicBulletinBoardTeacher.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private Pane loadMainPane() throws IOException, Exception {

        loader = new FXMLLoader(getClass().getResource("/fxml/LoginInterface.fxml"));
        Pane mainPane = (Pane) loader.load(getClass().getResourceAsStream(
                "/fxml/LoginInterface.fxml"
        )
        );
