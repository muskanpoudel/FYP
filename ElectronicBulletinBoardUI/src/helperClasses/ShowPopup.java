...
public class ShowPopup {
    ...
    public void showMessagePopup() throws IOException {
        FXMLLoader popuploader = new FXMLLoader(getClass().getResource("/fxml/setting.fxml"));
        Pane popupPane = (Pane) popuploader.load(getClass().getResourceAsStream("/fxml/setting.fxml"));
        ...
        stageHere.setTitle("Setting Box");
...
//        stageHere.getIcons().add(new Image(getClass().getResourceAsStream("/img/icon.png")));
        ...
        StuffHolder.setStagePopup(stageHere);
