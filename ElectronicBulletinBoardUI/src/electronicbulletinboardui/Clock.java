...
public class Clock {
    ...
    public ArrayList returnClock() {
        ...
        clocks.add(analogueClock);
        clocks.add(digitalClock);
        return clocks;
