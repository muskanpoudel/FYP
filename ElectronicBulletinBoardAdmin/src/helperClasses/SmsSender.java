...
public class SmsSender implements SmsEventListener{
    ...
    public SmsSender(String sender, String receiverNo, String Message) throws IOException {
        this.link = this; // Keeps this object alive.
        this.transceiver = SmsTransceiver.getInstance(); // Get the transceiver object.
        prop = propertyFileHandler.getProperty();   //getting property to get ip and port of sms host

        // Initialize transceiver.
        String smsHost = prop.getProperty("smshostip");
        String smsPort = prop.getProperty("smshostport");
        String smsUsername = prop.getProperty("smsusername");
       ...
       // sms.setSender(sender); // Set the sender number.
        ...
        sms.setRecipient(receiverNo); // The recipients phone number.

        //sms.setType( "flash" ); // Needed if you are to send flash messages.
        sms.setFromAlpha(sender); // A "from" string if you are not using setSender(). Max 10 characters.
