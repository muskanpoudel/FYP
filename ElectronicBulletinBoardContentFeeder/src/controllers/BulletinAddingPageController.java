 ...
 * @author Muskan
 */
public class BulletinAddingPageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            Logger.getLogger(BulletinAddingPageController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
